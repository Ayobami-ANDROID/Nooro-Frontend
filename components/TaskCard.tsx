...
const TaskCard: FC<TaskCardProps> = ({ id, title, completed, onTaskUpdate, onTaskDelete }) => {
    ...
    return (
        <div className={`bg-[rgba(38,38,38,1)] w-full flex justify-between items-center p-[16px] rounded-[8px] ${completed ? 'bg-[rgba(38,38,38,1)]':'bg-[rgba(51,51,51,1)]'}`}>
            ...
            <span className={`text-[rgba(242,242,242,1)] w-full px-3 font-[400] text-[14px] ${completed ? 'line-through text-[rgba(128,128,128,1)]' : ''}`}>
                {title}
            </span>
